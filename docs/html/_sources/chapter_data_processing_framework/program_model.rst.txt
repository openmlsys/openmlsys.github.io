...
.. _image_process_pipeline:

.. figure:: ../img/ch07/7.2/image_process_pipeline.png
   :width: 800px
...
:numref:`rdd_transformation_example`\ 的计算流程可视化中我们也可以清晰的看到用户在创建数据集后，只需要描述在数据集上的作用算子即可，至于算子的执行和实现则由系统的运行时负责。

.. _rdd_transformation_example:

.. figure:: ../img//ch07/7.2/RDD.png
   :width: 800px
...
.. _mindspore dataset example:

.. figure:: ../img/ch07/7.2/dataset_table.png
   :width: 800px
...
.. figure:: ../img/ch07/7.2/dataset.png

   MindSpore Dataset多种生成方式
...
.. _mindspore operator example:

.. figure:: ../img/ch07/7.2/operation.png
   :width: 800px

   MindData的C层算子和Python层算子
...
.. _mindspore_user_defined_operator:

.. figure:: ../img/ch07/7.2/dataset-plugin.png
   :width: 800px
